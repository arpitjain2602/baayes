...
setup(
  ...
  download_url = 'https://github.com/arpitjain2602/baayes/archive/refs/tags/0.1.tar.gz',    # I explain this later on
  keywords = ['Bayesian'],   # Keywords that define your package best
  install_requires=[            # I get to this in a second
          'pandas',
          'numpy','sklearn==0.22.1','hyperopt==0.2.3','lightgbm','imblearn==0.5.0','xgboost==0.90'
      ],
  classifiers=[
